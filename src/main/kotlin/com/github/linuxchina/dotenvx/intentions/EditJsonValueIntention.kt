...
/**
 * Intention: edit encrypted value in JSON files using dotenv.public.key.
 * Shown when the file contains dotenv.public.key and the value is not already encrypted.
 */
class EditJsonValueIntention : PsiElementBaseIntentionAction(), DumbAware, Iconable {

    override fun getFamilyName(): String = "Dotenvx"

    override fun getText(): String = "Edit encrypted JSON value"
    ...
    override fun invoke(project: Project, editor: Editor?, element: PsiElement) {
        ...
        val file = jsonLiteral.containingFile ?: return
        val publicKey = findPublicKey(file) ?: return
        val originalText = jsonLiteral.text
        ...
        WriteCommandAction.runWriteCommandAction(project) {
            val range = jsonLiteral.textRange
