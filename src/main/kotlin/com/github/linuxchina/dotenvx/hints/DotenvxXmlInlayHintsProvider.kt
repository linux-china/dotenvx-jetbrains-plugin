 ...
 */
class DotenvxXmlInlayHintsProvider : InlayHintsProvider, DumbAware {
    ...
    override fun createCollector(
        ...
        if (file.text.contains("encrypted:")) {
            ...
            return DotenvxXmlCollector(publicKey, privateKey)
        }
        return null
    }
}
...
class DotenvxXmlCollector(val publicKey: String, val privateKey: String?) : SharedBypassCollector {
